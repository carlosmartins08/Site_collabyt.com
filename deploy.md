...
- To capture leads from the contact modal, set `VITE_CONTACT_ENDPOINT` in your environment so the form can POST to your webhook/API. Without it the UI surfaces an explanatory error message.

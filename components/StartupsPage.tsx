...
const content = {
  'pt-br': {
      ...
      items: [
        {
          ...
          description: 'O público não entende rápido o que você resolve.',
        },
        {
          title: 'Falta de páginas por intenção',
          description: 'Tudo está em uma página e o Google não sabe ranquear.',
        },
        {
    ...
    methodology: {
      ...
      steps: [
        'Interpretação do negócio e diferenciais',
    ...
    deliverables: {
      ...
      items: [
        'Mapa de clusters e páginas prioritárias',
        'Wireframe e copy orientados à conversão',
      ...
      items: [
        {
          ...
          description: 'páginas que respondem à busca por MVP e testes de mercado.',
          key: 'solutions',
        },
        {
    ...
    cta: {
      ...
      text: 'Receba um diagnóstico de cluster, páginas prioritárias e plano de execução.',

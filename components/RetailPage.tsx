...
const content = {
  'pt-br': {
    ...
    description:
      'Arquitetura de conteudo e SEO para varejo que busca conversao, omnichannel e crescimento sustentavel.',
    hero: {
      eyebrow: 'Conteudo e SEO para Varejo',
      heading: 'Varejo: experiencia de compra, conversao e escala',
      subheading:
        'Criamos um ecossistema de conteudo que aumenta descoberta, reduz custo de aquisicao e prova valor comercial.',
      ctaPrimary: 'Falar com especialista',
      ctaSecondary: 'Ver solucoes',
    },
    painPoints: {
      title: 'Principais desafios do varejo na busca organica',
      items: [
        {
          title: 'Baixa conversao em canais digitais',
          description: 'O trafego chega, mas nao se transforma em receita.',
        },
        {
          title: 'Pouca integracao omnichannel',
          description: 'A experiencia entre loja fisica e digital e inconsistente.',
        },
        {
          title: 'Conteudo sem foco em intencao',
          description: 'Paginas nao respondem as perguntas certas do cliente.',
        },
      ],
    },
    personas: {
      title: 'Personas alvo',
      items: [
        'Diretor de e-commerce buscando aumento de conversao',
    ...
    intents: {
      ...
      items: [
        'informacional: como aumentar conversao no varejo',
    ...
    methodology: {
      title: 'Metodo em 8 etapas para escalar o varejo digital',
      steps: [
        'Diagnostico de funil e canais',
        'Mapeamento de personas e jornada',
        'Pesquisa de intencoes e categorias',
        'Clusters por linhas e ofertas',
        'Paginas por solucao e campanha',
        'Interligacao com provas e cases',
        'SEO tecnico e performance',
        'Otimizacao para motores de IA',
      ],
    },
    deliverables: {
      title: 'Entregaveis para varejo',
      items: [
        'Mapa de conteudo por categoria e jornada',
        'Pilares de conversao e omnichannel',
        'Schema e SEO tecnico por pagina',
        'Plano de expansao por colecao/linha',
      ],
    },
    clusters: {
      ...
      items: [
        {
          title: 'Conversao e performance',
          description: 'Otimizacao de funil e jornada de compra.',
          key: 'solutions',
        },
        {
        ...
        {
          title: 'Metodo e operacao',
          description: 'Processos, testes e governanca.',
          key: 'methodology',
        },
        {
      ...
      items: [
        {
          ...
          a: 'Sim, estruturamos paginas e dados para integrar canais.',
        },
        {
          q: 'Quanto tempo para melhorar conversao?',
          a: 'Normalmente 4 a 8 semanas para sinais iniciais.',
        },
        {
          q: 'Preciso trocar minha plataforma?',
          a: 'Nao. O plano se adapta ao stack atual.',
        },
      ],
    },
    cta: {
      title: 'Vamos destravar conversao no varejo',
      text: 'Receba um plano de conteudo e SEO alinhado a receita.',

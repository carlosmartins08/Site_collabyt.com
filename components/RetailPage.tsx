  ...
  'pt-br': {
    ...
    painPoints: {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'A experiência entre loja física e digital é inconsistente.',
        },
        {
          title: 'Conteúdo sem foco em intenção',
          description: 'Páginas não respondem às perguntas certas do cliente.',
        },
      ],
    },
    personas: {
    ...
    methodology: {
      ...
      steps: [
        ...
        'Páginas por solução e campanha',
    ...
    clusters: {
      ...
      items: [
        ...
        {
          title: 'Dados e personalização',
          description: 'IA aplicada para recomendação e CRM.',
          key: 'tech',
        },
        {
    ...
    cta: {
      ...
      text: 'Receba um plano de Conteúdo e SEO alinhado à receita.',

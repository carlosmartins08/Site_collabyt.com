...
const content = {
  'pt-br': {
    ...
    personas: {
      title: 'Personas alvo',
      items: [
        'Diretor hospitalar buscando eficiência e reputação',
    ...
    methodology: {
      ...
      steps: [
        ...
        'Páginas por procedimento e dor crítica',
      ...
      items: [
        {
          ...
          description: 'Conteúdo para atrair pacientes e reduzir fricção.',
          key: 'solutions',
        },
        {
          title: 'Dados e prontuário digital',
        ...
        },
        {
          ...
          description: 'Resultados e impacto clínico.',
          key: 'projects',
        },
      ],
    },
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'Incluímos governança, segurança e Conteúdo alinhado à conformidade.',
        },
        {
